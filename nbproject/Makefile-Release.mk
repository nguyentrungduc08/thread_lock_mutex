...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/thread_lock_mutex: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/thread_lock_mutex ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/src/data_constants.o: src/data_constants.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/data_constants.o src/data_constants.cpp

${OBJECTDIR}/src/data_types.o: src/data_types.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/data_types.o src/data_types.cpp
